...
class Utilizator:
    def __init__(self, nume, _nivel_acces="Default"):
        self.nume = nume
        self._nivel_acces = _nivel_acces
...
class UtilizatorManager(Utilizator):
    def __init__(self, nume):
        super().__init__(nume, _nivel_acces="Manager")
...
class UtilizatorAdmin(Utilizator):
    def __init__(self, nume):
        super().__init__(nume, _nivel_acces="Admin")
...
class user:
    ...
    @nivel_acces.setter
    def nivel_acces(self, new_nivel_acces):
        self.__nivel_acces = new_nivel_acces
...
class Sistem:
    ...
    def modifica_name_user(self, user_id, new_name):
        if user_id in self.__utilizatori:
            self.__utilizatori[user_id].name = new_name
        else:
    ...
    def modifica_nivel_acces(self, user_id, new_nivel_acces):
        if user_id in self.__utilizatori:
            self.__utilizatori[user_id].nivel_acces = new_nivel_acces
        else:
            print("Utilizatorul nu exista.")
# CODUL TĂU VINE MAI SUS:
