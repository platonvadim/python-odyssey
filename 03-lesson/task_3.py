...
# CODUL TĂU VINE MAI JOS:
print(number+1, number3+1)
print(number-2, number3-1)
print(number*3, number3*3)
print(number/4, number3/4)
print(number%5, number3%5)
print(number**6, number3**6)
print(number//7, number3//7)
# CODUL TĂU VINE MAI SUS:

# Creează o nouă variabilă numită `number4` și atribuie-i o valoare numerică mare într-un mod literal

# CODUL TĂU VINE MAI JOS:
number4 = 999_999_999_999
# CODUL TĂU VINE MAI SUS:
